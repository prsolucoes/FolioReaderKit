...
open class FolioReaderCenter: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override open func viewDidLoad() {
        ...
        let background = folioReader.isNight(self.readerConfig.nightModeBackground, UIColor(rgba: "#FBF0DB"))
    ...
    func configureNavBar() {
        let navBackground = folioReader.isNight(self.readerConfig.nightModeMenuBackground, UIColor(rgba: "#FBF0DB"))
    ...
    public func getCurrentPageProgress() -> Float {
        guard let page = currentPage, let _ = page.webView else { return 0 }
